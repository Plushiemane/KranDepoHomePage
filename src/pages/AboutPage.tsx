...
const ContactItem: React.FC<ContactItemProps> = ({ icon, title, content }) => {
  return (
    <div className="flex items-center p-3 mx-auto w-full mb-4">
      <div className="bs-icon-md bs-icon-rounded bs-icon-primary flex flex-shrink-0 justify-center items-center  bs-icon bg-[rgb(153,95,69)]">
        {icon}
      </div>
...
const AboutPage: React.FC = () => {
  return (
    <Layout title="O nas">
      <section className="w-[95%] min-h-fit mx-auto mb-4 py-6 px-2 
        ...
        <section className="bg-black/80 text-white w-[95%] mx-auto rounded-[25px] p-4 mb-8"
          ...
          <ContactItem 
            icon={
              <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" className="bi bi-pin mb-4">
